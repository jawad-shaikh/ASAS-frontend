...
export const parentRegister = (data: any) => API.post('/parents/auth/register', data)

export const providerLogin = (data: any) => API.post('/activity-providers/auth/login', data)

export const providerRegister = (data: any) => API.post('/activity-providers/auth/register', data)
...
export const getAllActivity = (id: number) => API.get(`/activities?activityProviderId=${id}`);

export const updateProvider = (id: number, data:any) => API.post(`/activity-providers/status/${id}`, data);
